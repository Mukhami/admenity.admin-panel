...
@section('title', 'Performance by Sector')
@section('content')
    <style>
        /*.positioning{*/
        /*    position: absolute;*/
                    ...
                    <div class="col-xl-10 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add New- Performance by Sector</h5>
